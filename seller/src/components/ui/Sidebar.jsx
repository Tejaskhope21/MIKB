  ...
  return (
    <SidebarContext.Provider value={contextValue}>
      <div
        ...
        className={`flex min-h-svh w-full has-data-[variant=inset]:bg-sidebar ${className}`}
        ref={ref}
        {...rest}
      >
        {children}
...
const Sidebar = React.forwardRef((props, ref) => {
  ...
  if (isMobile) {
    return (
      <div open={openMobile} onOpenChange={setOpenMobile} {...rest}>
        <div
...
const SidebarGroupLabel = React.forwardRef((props, ref) => {
  ...
  return (
    <Comp
      ...
      className={`duration-200 flex h-8 shrink-0 items-center rounded-md px-2 text-xs font-medium text-sidebar-foreground/70 outline-hidden ring-sidebar-ring transition-[margin,opa] ease-linear focus-visible:ring-2 [&>svg]:size-4 [&>svg]:shrink-0
...
const SidebarGroupAction = React.forwardRef((props, ref) => {
  ...
  return (
    <Comp
      ...
      className={`absolute right-3 top-3.5 flex aspect-square w-5 items-center justify-center rounded-md p-0 text-sidebar-foreground outline-hidden ring-sidebar-ring transition-transform hover:bg-sidebar-accent hover:text-sidebar-accent-foreground focus-visible:ring-2 [&>svg]:size-4 [&>svg]:shrink-0
...
const SidebarMenuAction = React.forwardRef((props, ref) => {
  ...
  return (
    <Comp
      ...
      className={`absolute right-1 top-1.5 flex aspect-square w-5 items-center justify-center rounded-md p-0 text-sidebar-foreground outline-hidden ring-sidebar-ring transition-transform hover:bg-sidebar-accent hover:text-sidebar-accent-foreground focus-visible:ring-2 peer-hover/menu-button:text-sidebar-accent-foreground
        after:absolute after:-inset-2 md:after:hidden
...
const SidebarMenuBadge = React.forwardRef((props, ref) => {
  ...
  return (
    <div
      ...
      className={`absolute right-1 flex h-5 min-w-5 items-center justify-center rounded-md px-1 text-xs font-medium tabular-nums text-sidebar-foreground select-none pointer-events-none
...
const SidebarMenuSubButton = React.forwardRef((props, ref) => {
  ...
  return (
    <Comp
      ...
      data-size={size}
      data-active={isActive}
      className={`flex h-7 min-w-0 -translate-x-px items-center gap-2 overflow-hidden rounded-md px-2 text-sidebar-foreground outline-hidden ring-sidebar-ring hover:bg-sidebar-accent hover:text-sidebar-accent-foreground focus-visible:ring-2 active:bg-sidebar-accent active:text-sidebar-accent-foreground disabled:pointer-events-none disabled:opacity-50 aria-disabled:pointer-events-none aria-disabled:opacity-50 [&>span:last-child]:truncate [&>svg]:size-4 [&>svg]:shrink-0 [&>svg]:text-sidebar-accent-foreground
