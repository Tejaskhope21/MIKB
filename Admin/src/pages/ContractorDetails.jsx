...
const ContractorDetails = () => {
    ...
    const handleVerify = async () => {
        if (!window.confirm('Are you sure you want to verify this contractor?')) return;

        try {
            const token = localStorage.getItem('token');
            
            await axios.put(`${API_URL}/admin/contractors/${id}/verify`, {}, {
                headers: { Authorization: `Bearer ${token}` }
            });
    ...
    const handleUnverify = async () => {
        if (!window.confirm('Are you sure you want to reject this contractor?')) return;

        try {
            const token = localStorage.getItem('token');
            
            await axios.put(`${API_URL}/admin/contractors/${id}/unverify`, {}, {
                headers: { Authorization: `Bearer ${token}` }
            });
    ...
    const handleDelete = async () => {
        if (!window.confirm('Are you sure you want to delete this contractor permanently?')) return;
        ...
        return (
            <div className="flex items-center justify-center min-h-screen">
                <div className="text-center">
                    ...
                    <p className="mt-6 text-xl text-gray-700">Loading contractor details...</p>
                </div>
            </div>
        );
    }
    ...
    if (!contractor) {
        return (
            <div className="text-center p-12">
                ...
                <h2 className="text-2xl font-bold text-gray-800 mb-4">Contractor Not Found</h2>
                <p className="text-gray-600 mb-8">The contractor you're looking for doesn't exist.</p>
                <Link
    ...
    return (
        <div className="p-6 max-w-7xl mx-auto">
            ...
            <div className="mb-8">
                ...
                <div className="flex justify-between items-start">
                    <div>
                        ...
                        <p className="text-gray-600">{contractor.name} • {contractor.contractorType}</p>
                    </div>
            ...
            {/* Status Badge */}
            <div className="mb-8">
                {contractor.verificationStatus === 'verified' && contractor.isVerified ? (
                    <div className="inline-flex items-center gap-2 px-6 py-3 bg-green-100 text-green-800 rounded-xl">
                        ...
                        <span className="text-sm">• Verified on {new Date(contractor.updatedAt).toLocaleDateString()}</span>
                    </div>
                ) : contractor.verificationStatus === 'pending' ? (
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="grid grid-cols-2 gap-4">
                                    <div>
                                        ...
                                        <p className="font-medium">{contractor.address?.city || 'Not specified'}</p>
                                    </div>
                                    <div>
                                        <p className="text-sm text-gray-500 mb-1">State</p>
                                        <p className="font-medium">{contractor.address?.state || 'Not specified'}</p>
                                    </div>
                                    <div>
                                        <p className="text-sm text-gray-500 mb-1">Pincode</p>
                                        <p className="font-medium">{contractor.address?.pincode || 'Not specified'}</p>
                                    </div>
                                    <div>
                                        <p className="text-sm text-gray-500 mb-1">Country</p>
                                        <p className="font-medium">{contractor.address?.country || 'India'}</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="space-y-8">
                            ...
                            <div className="space-y-6">
                                <div className="flex items-center justify-between">
                                    <div className="flex items-center gap-3">
                                        ...
                                        <div>
                                            <p className="font-bold text-2xl">{contractor.experience || 0}</p>
                                ...
                                <div className="flex items-center justify-between">
                                    <div className="flex items-center gap-3">
                                        ...
                                        <div>
                                            <p className="font-bold text-2xl">{contractor.projectsCompleted || 0}</p>
                                ...
                                <div className="flex items-center justify-between">
                                    <div className="flex items-center gap-3">
                                        ...
                                        <div>
                                            <p className="font-bold text-2xl">{contractor.teamSize || '1-5'}</p>
                            ...
                            <div className="space-y-4">
                                ...
                                <div>
                                    ...
                                    <div className="flex items-center gap-2">
                                        <Calendar className="w-4 h-4 text-gray-400" />
                                        <p className="font-medium">
                                            {new Date(contractor.updatedAt).toLocaleDateString('en-IN', {
                                                day: 'numeric',
                                                month: 'long',
                                                year: 'numeric'
                                            })}
                                ...
                                <div>
                                    ...
                                    <p className={`font-bold ${contractor.isActive ? 'text-green-600' : 'text-red-600'}`}>
                        ...
                        {contractor.specialties && contractor.specialties.length > 0 && (
                            <div className="bg-white rounded-xl shadow-lg p-8">
                                <h2 className="text-xl font-bold text-gray-900 mb-6">Specialties</h2>
                ...
                <div className="bg-white rounded-xl shadow-lg p-8">
                    ...
                    {contractor.portfolio?.length > 0 ? (
                                ...
                                <div key={index} className="border border-gray-200 rounded-xl overflow-hidden hover:shadow-lg transition-shadow">
                                    ...
                                    <div className="p-6">
                                        <div className="flex justify-between items-start mb-3">
                                            ...
                                            <span className={`px-2 py-1 text-xs rounded-full ${project.status === 'completed' ? 'bg-green-100 text-green-800' : 'bg-yellow-100 text-yellow-800'}`}>
                                                {project.status}
                                            </span>
                                        </div>
                        ...
                        <div className="text-center py-12">
                            ...
                            <h3 className="text-xl font-bold text-gray-700 mb-2">No Portfolio Projects</h3>
                            <p className="text-gray-500">This contractor hasn't added any portfolio projects yet.</p>
                        </div>
                    )}
                </div>
            )}
            ...
            {activeTab === 'documents' && (
                <div className="bg-white rounded-xl shadow-lg p-8">
                    <h2 className="text-2xl font-bold text-gray-900 mb-8">Documents & Verification</h2>
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="border border-gray-200 rounded-xl p-6">
                            <div className="flex justify-between items-start mb-4">
                                <div>
                                    <h3 className="font-bold text-lg text-gray-900">Contractor License</h3>
                                    <p className="text-gray-600">License Number: {contractor.licenseNumber}</p>
                                </div>
                        ...
                        {/* Verification Status */}
                        <div className="border border-gray-200 rounded-xl p-6">
                            <h3 className="font-bold text-lg text-gray-900 mb-4">Verification History</h3>
                            <div className="space-y-4">
                                <div className="flex items-center justify-between">
                                    <div>
