    ...
    return (
      <SafeAreaView style={styles.errorContainer}>
        <View style={styles.errorContent}>
          <MaterialCommunityIcons name="package-variant" size={80} color="#800000" />
      ...
      >
        ...
        <View style={styles.productInfo}>
          ...
          <View style={styles.stockContainer}>
            <View style={[styles.stockBadge, isInStock ? styles.inStock : styles.outOfStock]}>
              <Ionicons
        ...
        {relatedProducts.length > 0 && (
          <View style={styles.relatedProducts}>
            ...
            {loadingRelated ? (
              <ActivityIndicator size="large" color="#800000" style={{ marginVertical: 20 }} />
            ) : (
              <ScrollView
                horizontal
                showsHorizontalScrollIndicator={false}
