  ...
  const processImage = async (uri, base64, fileSize = null) => {
    try {
      ...
      if (fileSizeMB > 5) {
        Alert.alert(
          "File Too Large",
          "Image must be less than 5MB. Please select a smaller image.",
        );
    ...
    if (paymentMethod === "bank_transfer") {
      if (!bankTransferDetails.transactionId.trim()) {
        Alert.alert(
          ...
          "Please enter transaction ID / UPI reference",
        );
        return false;
      }
              ...
              <>
                ...
                >
                  <Ionicons
                    ...
                    color="#800000"
                  />
                  <Text style={styles.addNewAddressLinkText}>
                    Add New Address
                  </Text>
                </TouchableOpacity>
              </>
                    ...
                    {bankTransferDetails.screenshot ? (
                      <View style={styles.imagePreviewContainer}>
                        <Image
                          source={{
                            uri:
                              bankTransferDetails.screenshotUri ||
                              bankTransferDetails.screenshot,
                          }}
      ...
      <View style={styles.footer}>
        ...
        <TouchableOpacity
          style={[
            ...
            (loading || uploadingImage) && styles.placeOrderButtonDisabled,
          ]}
