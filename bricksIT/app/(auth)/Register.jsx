...
export default function RegisterScreen() {
  ...
  const validateForm = () => {
    ...
    if (activeTab === "user") {
      ...
      if (userForm.phone && !/^[0-9]{10}$/.test(userForm.phone))
      ...
      const emailRegex = /^[^\s@]+@[^\s@]+\.[^\s@]+$/;
      if (!emailRegex.test(contractorForm.email))
        return "Valid email is required";
      if (contractorForm.password.length < 6)
        return "Password must be at least 6 characters";
      if (!contractorForm.phone.match(/^[0-9]{10}$/))
        return "Valid 10-digit phone number is required";
      ...
      if (!contractorForm.experience || parseInt(contractorForm.experience) < 1)
        return "Experience must be at least 1 year";
      if (!contractorForm.licenseNumber.trim())
        return "License number is required";
      if (!contractorForm.address.trim()) return "Address is required";
      if (contractorForm.specialties.length === 0)
      ...
      <View style={styles.inputRow}>
        ...
        <View style={styles.inputContainer}>
          ...
          <TextInput
            ...
            onChangeText={(text) =>
              handleSellerChange("gstNumber", text.toUpperCase())
            }
            editable={!loading}
          />
        </View>
      ...
      <View style={styles.inputRow}>
        <View style={styles.inputContainer}>
          ...
          <TextInput
            ...
            onChangeText={(text) =>
              handleSellerChange("bankAccountNumber", text)
            }
        ...
        <View style={styles.inputContainer}>
          ...
          <TextInput
            ...
            onChangeText={(text) =>
              handleSellerChange("bankIFSC", text.toUpperCase())
            }
            editable={!loading}
          />
        </View>
      ...
      <View style={styles.inputRow}>
        ...
        <View style={styles.inputContainer}>
          ...
          <TextInput
            ...
            onChangeText={(text) =>
              handleContractorChange("licenseNumber", text)
            }
            editable={!loading}
          />
        </View>
            ...
            >
              {contractorForm.teamSize
                ? teamSizeOptions.find(
                    (opt) => opt.value === contractorForm.teamSize,
                  )?.label
                : "Select Size"}
            </Text>
            <Icon name="chevron-down" size={20} color="#666" />
          ...
          <Text
            style={
              contractorForm.specialties.length > 0
                ? styles.specialtiesButtonText
                : styles.specialtiesButtonPlaceholder
            }
          >
            {contractorForm.specialties.length > 0
      ...
      <View style={styles.inputRow}>
        ...
        <View style={styles.inputContainer}>
          ...
          <TextInput
            ...
            onChangeText={(text) =>
              handleContractorChange("projectsCompleted", text)
            }
            keyboardType="numeric"
            editable={!loading}
          />
              ...
              >
                ...
                <Text style={styles.termsText}>
                  ...
                  <Text
                    style={styles.termsLink}
                    onPress={() =>
                      Alert.alert("Privacy Policy", "Demo privacy policy.")
                    }
                  >
                    Privacy Policy
                  </Text>
