...
export default function PortfolioScreen() {
  ...
  const fetchProjects = async () => {
    try {
      ...
      const response = await axios.get(`${API_URL}/v1/contractor/portfolio/projects`, {
        headers: {
  ...
  const fetchDashboardStats = async () => {
    try {
      const token = await AsyncStorage.getItem('token');
      const response = await axios.get(`${API_URL}/v1/contractor/stats/dashboard`, {
        headers: {
          Authorization: `Bearer ${token}`,
        },
      });
  ...
  const handleAddProject = async () => {
    if (!newProject.title || !newProject.description || !newProject.clientName) {
        ...
        {projects.map((project) => (
          <TouchableOpacity key={project._id} style={styles.projectCard}>
            ...
            <View style={styles.projectFooter}>
              ...
              <Text style={styles.projectBudget}>{formatCurrency(project.budget || 0)}</Text>
            </View>
            ...
            <View style={styles.inputRow}>
              <View style={[styles.inputGroup, {flex: 1}]}>
                ...
                <TextInput
                  ...
                  onChangeText={(text) => setNewProject({...newProject, category: text})}
                />
              </View>
        ...
        <View style={styles.modalContent}>
          ...
          <ScrollView style={styles.modalBody}>
            <View style={styles.profileHeader}>
              ...
              <Text style={styles.profileCompany}>{profileData.companyName}</Text>
            </View>
            ...
            <View style={styles.infoSection}>
              ...
              <Text style={styles.infoValue}>{profileData.experience} years</Text>
            </View>
        ...
        <View style={styles.content}>
          <View style={styles.projectsHeader}>
            ...
            <TouchableOpacity 
              ...
              onPress={() => router.push('/(contractor)/portfolio/all-projects')}
            >
