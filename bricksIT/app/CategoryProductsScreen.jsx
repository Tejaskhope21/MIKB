...
const CategoryProductsScreen = () => {
  ...
  console.log('Category Params:', { categoryId, categoryName, subcategoryId, subcategoryName });
            ...
            {subcategories.length > 0 && (
              <View style={styles.filterSection}>
                <TouchableOpacity
                  ...
                  onPress={() => setShowSubcategoryFilter(!showSubcategoryFilter)}
                >
                ...
                {showSubcategoryFilter && (
                  <View style={styles.filterOptions}>
                    ...
                    >
                      ...
                      <Text style={styles.filterCount}>{productStats.total}</Text>
                    </TouchableOpacity>
                    ...
                    {subcategories.map((subcat) => (
                      <TouchableOpacity
                        ...
                        style={[
                          styles.filterOption,
                          (selectedSubcategory === subcat._id || selectedSubcategory === subcat.id) && styles.filterOptionSelected
                        ]}
                        onPress={() => handleSubcategoryClick(subcat._id || subcat.id)}
                      >
                        <Text style={[
                          styles.filterOptionText,
                          (selectedSubcategory === subcat._id || selectedSubcategory === subcat.id) && styles.filterOptionTextSelected
                        ]}>{subcat.title}</Text>
                        <Text style={styles.filterCount}>{subcat.count || 0}</Text>
                      </TouchableOpacity>
                    ))}
                  </View>
                )}
                  ...
                  <View style={styles.filterOptions}>
                    ...
                    {brands.map((brand) => (
                      ...
                      >
                        ...
                        <Text style={styles.filterCount}>{productStats.brandCounts[brand] || 0}</Text>
                      </TouchableOpacity>
                    ))}
                  </View>
                )}
            ...
            <View style={styles.filterSection}>
              ...
              >
                <View style={[
                  ...
                  {modernOnly && <Ionicons name="checkmark" size={16} color="#fff" />}
                </View>
                <Text style={styles.filterOptionText}>Modern Designs Only</Text>
                {modernOnly && (
                  <Text style={styles.filterCount}>{productStats.modernCount}</Text>
                )}
              </TouchableOpacity>
            </View>
          </ScrollView>
    ...
    return (
      <SafeAreaView style={styles.container}>
        ...
        <View style={styles.errorContainer}>
          ...
          <TouchableOpacity style={styles.retryButton} onPress={fetchCategoryWithSubcategories}>
    ...
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.header}>
        ...
        <View style={styles.headerTitleContainer}>
          <Text style={styles.headerTitle} numberOfLines={1}>
            {currentSubcategory ? currentSubcategory.title : (category?.name || categoryName || 'Products')}
          </Text>
          {products.length > 0 && (
      ...
      <View style={styles.viewToggleContainer}>
        ...
        <TouchableOpacity onPress={() => setShowFilters(true)}>
          <Text style={styles.filterText}>
            Filter {hasActiveFilters && `(${Object.keys(productStats.brandCounts).length})`}
          </Text>
        </TouchableOpacity>
      </View>
      ...
      {products.length > 0 ? (
        <FlatList
          ...
          keyExtractor={(item) => item._id || item.numericId || Math.random().toString()}
            ...
            pagination.pages > 1 ? (
              <View style={styles.paginationContainer}>
                <TouchableOpacity
                  ...
                  onPress={() => setPagination(prev => ({ ...prev, page: Math.max(1, prev.page - 1) }))}
                ...
                <TouchableOpacity
                  ...
                  onPress={() => setPagination(prev => ({ ...prev, page: Math.min(pagination.pages, prev.page + 1) }))}
