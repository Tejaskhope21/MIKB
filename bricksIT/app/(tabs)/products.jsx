...
export default function AllProductsScreen() {
    ...
    const uniqueBrands = [
      ...new Set(
        productList
          ...
          .filter(
            (brand) =>
              brand && brand.trim() !== "" && brand !== "Unknown Brand",
          )
  ...
  useEffect(() => {
    const init = async () => {
      await Promise.all([fetchCategories(), fetchAllBrands(), fetchProducts()]);
    };
    init();
  }, []);
  ...
  const renderProductItem = ({ item }) => {
    ...
    const currentPrice =
      item.price || item.sellingPrice || item.discountedPrice || 0;
    let discount = 0;
                ...
                <View style={styles.categoryGrid}>
                  <TouchableOpacity
                    style={[
                      ...
                      selectedCategory === "all" &&
                        styles.categoryChipModalSelected,
                    ]}
                    onPress={() => handleCategorySelect("all")}
                  >
                    <Text
                      style={[
                        ...
                        selectedCategory === "all" &&
                          styles.categoryChipModalTextSelected,
                      ]}
                    >
                      All Categories
                    </Text>
                  ...
                  <View style={styles.subcategoryGrid}>
                    <TouchableOpacity
                      style={[
                        ...
                        selectedSubcategory === "all" &&
                          styles.subcategoryChipModalSelected,
                      ]}
                      onPress={() => setSelectedSubcategory("all")}
                    >
                      <Text
                        style={[
                          ...
                          selectedSubcategory === "all" &&
                            styles.subcategoryChipModalTextSelected,
                        ]}
                      >
                        All Subcategories
                      </Text>
                    ...
                    >
                      <Text
                        style={[
                          ...
                          selectedBrand === "all" &&
                            styles.brandChipModalTextSelected,
                        ]}
                      >
                        All Brands
                      </Text>
