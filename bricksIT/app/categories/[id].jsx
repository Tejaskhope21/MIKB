...
export default function CategoryProductsScreen() {
  ...
  // ✅ PARAMS FROM URL
  const { id, name, subcategoryId, subcategoryName } = useLocalSearchParams();
  ...
  const fetchCategoryWithSubcategories = async () => {
    try {
      ...
      if (subcategoryId && data.subcategories?.length > 0) {
        let foundSubcategory = data.subcategories.find(
          (sub) => sub._id === subcategoryId || sub.id === subcategoryId,
        );

        if (!foundSubcategory) {
          foundSubcategory = data.subcategories.find(
  ...
  const renderSubcategoryItem = ({ item }) => (
    <TouchableOpacity
      style={[
        ...
        (selectedSubcategory === item._id || selectedSubcategory === item.id) &&
                ...
                >
                  <Text
                    style={[
                      ...
                      selectedSubcategory === (sub._id || sub.id) &&
                        styles.quickFilterBadgeTextActive,
                    ]}
                  >
                    {sub.count || 0}
                  </Text>
      ...
      <View style={styles.resultsHeader}>
        <View>
          <Text style={styles.resultsTitle}>
            {currentSubcategory ? currentSubcategory.title : "All Products"}
          </Text>
              ...
              <View style={styles.filterSection}>
                ...
                >
                  ...
                  <View style={styles.filterOptionBadge}>
                    <Text style={styles.filterOptionBadgeText}>
                  ...
                  <View style={styles.statsContainer}>
                    <View style={styles.statRow}>
                      ...
                      {productStats.withDiscount > 0 && (
                        <View style={styles.statItem}>
                          <View
                            style={[styles.statIcon, styles.discountStatIcon]}
                          >
                            <MaterialIcons
                              name="local-offer"
                              size={18}
                          ...
                          <View style={styles.statContent}>
                            ...
                            <Text
                              style={[styles.statValue, styles.discountStat]}
                            >
                    ...
                    <View style={styles.statRow}>
                      {productStats.minPrice > 0 &&
                        productStats.maxPrice > 0 && (
                          <View style={styles.statItem}>
                            <View
                              style={[styles.statIcon, styles.priceStatIcon]}
                            >
                              <MaterialIcons
                                name="currency-rupee"
                                size={18}
