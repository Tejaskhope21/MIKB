...
const StoreSettings = () => {
      ...
      shippingZones: [
        {
          name: "Local",
          countries: ["India"],
          rates: { standard: 49, express: 99 },
        },
        {
          name: "International",
          countries: ["All"],
          rates: { standard: 499, express: 999 },
        },
      ],
    },
  ...
  const removeShippingMethod = (index) => {
    const updatedMethods = storeSettings.shipping.shippingMethods.filter(
      (_, i) => i !== index,
    );
    setStoreSettings({
      ...storeSettings,
            ...
            <div className="space-y-4">
                ...
                <div className="text-right">
                  ...
                  <div className="flex items-center gap-2">
                    <span className="text-sm">
                      ₹{storeSettings.payment.codMinOrder}
                    </span>
                    <span className="text-gray-400">-</span>
                    <span className="text-sm">
                      ₹{storeSettings.payment.codMaxOrder}
                    </span>
                  </div>
                </div>
              </div>
                  ...
                  {[
                    {
                      ...
                      label: "Razorpay",
                      field: "razorpayKey",
                      value: storeSettings.payment.razorpayKey,
                    },
                    {
                      id: "stripe",
                      label: "Stripe",
                      field: "stripeKey",
                      value: storeSettings.payment.stripeKey,
                    },
                    {
                      id: "paypal",
                      label: "PayPal",
                    ...
                    <div key={payment.id} className="flex items-center">
                      <input
                        type="checkbox"
                        checked={storeSettings.payment.acceptedMethods.includes(
                          payment.id,
                        )}
                        onChange={(e) => {
                          const methods = e.target.checked
                            ? [
                                ...storeSettings.payment.acceptedMethods,
                                payment.id,
                              ]
                            : storeSettings.payment.acceptedMethods.filter(
                                (m) => m !== payment.id,
                              );
                          handleInputChange(
                            "payment",
              ...
              <div className="flex items-center justify-between p-4 border border-gray-200 rounded-lg">
                <div>
                  ...
                  <p className="text-sm text-gray-500">
                    Automatically confirm orders when payment is successful
                  </p>
                </div>
                <input
                  type="checkbox"
            ...
            <div className="flex items-center justify-between">
              ...
              <label className="flex items-center">
                <input
                  ...
                  onChange={(e) =>
                    handleInputChange("tax", "enableTax", e.target.checked)
                  }
                  className="rounded border-gray-300 text-blue-600 mr-2"
                />
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="flex items-center">
                <label className="flex items-center">
                  <input
                    ...
                    onChange={(e) =>
                      handleInputChange("tax", "taxInclusive", e.target.checked)
                    }
                    className="rounded border-gray-300 text-blue-600 mr-2"
                  />
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    handleInputChange("tax", "gstNumber", e.target.value)
                  }
                  className="w-full px-4 py-2 border border-gray-300 rounded-lg"
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    handleInputChange("tax", "panNumber", e.target.value)
                  }
                  className="w-full px-4 py-2 border border-gray-300 rounded-lg"
                ...
                <div className="space-y-3">
                  {[
                    ...
                    },
                    {
                      ...
                      description: "When a new review is posted",
                    },
                    {
                      id: "marketingEmails",
                      label: "Marketing Emails",
                      description: "Receive marketing updates and tips",
                    },
                  ].map((alert) => (
                    <div
                      key={alert.id}
