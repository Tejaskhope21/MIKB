                ...
                {isSubmitted && (
                    <div className="mb-8 p-4 bg-green-50 border border-green-200 text-green-800 rounded-xl">
                        <div className="flex items-center">
                            ...
                            <p className="font-semibold">Thank you for your interest in MIKB! Our team will contact you within 24 hours.</p>
                        </div>
                    </div>
                )}
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                                ...
                                <div className="flex items-start">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-orange-100">investors@MIKB.com</p>
                        ...
                        <div className="sticky top-8">
                            <div className="bg-white rounded-xl shadow-lg border border-orange-200 p-6">
                                <div className="text-center mb-6">
                                    <h2 className="text-2xl font-bold text-gray-900">Invest in MIKB</h2>
                                    ...
                                    <div className="space-y-4">
                                        ...
                                        <div className="flex items-start">
                                            ...
                                            <label htmlFor="agreeTerms" className="text-sm text-gray-700">
                                                I agree to receive information about MIKB investment opportunity. I understand this is not a commitment to invest.
                                            </label>
                                        </div>
                                ...
                                <div className="mt-6 pt-6 border-t border-orange-200">
                                    <h3 className="font-bold text-gray-900 mb-3">Why Invest in MIKB?</h3>
